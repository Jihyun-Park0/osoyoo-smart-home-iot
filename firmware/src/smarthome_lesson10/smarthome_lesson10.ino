 ...
 *                  (____/ 
 * Use browser and OSOYOO MEGA-IoT extension shield to detect remote fire status
 * Tutorial URL http://osoyoo.com/?p=28816
...
{ pinMode(buzzer, OUTPUT);	// initialize digital pin Red LED as an output.
  ...
  pinMode(flame_sensor, INPUT);  // initialize gas sensor pin input.
...
void sendHttpResponse(WiFiEspClient client)
{
  ...
  client.print("<meta http-equiv=\"refresh\" content=\"5\"/>Safety Status: ");
    client.print(gasStr);
}
