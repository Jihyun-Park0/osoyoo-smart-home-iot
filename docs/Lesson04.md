...
|            |                         LED ON                          |                          LED OFF                          |
|------------|:-------------------------------------------------------:|:---------------------------------------------------------:|
| Web        | ![web_led_on.png](/docs/assets/lesson04/web_led_on.png) | ![web_led_off.png](/docs/assets/lesson04/web_led_off.png) |
| Smart Home |     ![led_on.png](/docs/assets/lesson04/led_on.png)     |     ![led_off.png](/docs/assets/lesson04/led_off.png)     |
